...
SCALE = {
    ...
    3: ('bilijun', 'bilijuna', 'bilijuna', False),  # 10^9
    4: ('trilijun', 'trilijuna', 'trilijuna', False),  # 10^12
    5: ('kvadrilijun', 'kvadrilijuna', 'kvadrilijuna', False),  # 10^15
    6: ('kvintilijun', 'kvintilijuna', 'kvintilijuna', False),  # 10^18
    7: ('sekstilijun', 'sekstilijuna', 'sekstilijuna', False),  # 10^21
    8: ('septilijun', 'septilijuna', 'septilijuna', False),  # 10^24
    9: ('oktilijun', 'oktilijuna', 'oktilijuna', False),  # 10^27
    10: ('nonilijun', 'nonilijuna', 'nonilijuna', False),  # 10^30
}
