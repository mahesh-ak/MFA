...
class Num2Word_GL(Num2Word_EU):
    ...
    def setup(self):
        super(Num2Word_GL, self).setup()
        lows = ["quatr", "tr", "b", "m"]
        self.high_numwords = self.gen_high_numwords([], [], lows)
        self.negword = "menos "
        self.pointword = "coma"
        self.exclude_title = ["e", "coma", "menos"]
        ...
        self.low_numwords = [
            "vinte", "dezanove", "dezoito", "dezasete", "dezaseis",
            "quinze", "catorce", "treze", "doze", "onze", "dez",
            "nove", "oito", "sete", "seis", "cinco", "quatro", "três", "dous",
            "un", "zero"
        ]
        self.ords = [
            {
    ...
    def to_cardinal(self, value):
        result = super(Num2Word_GL, self).to_cardinal(value)

        # Transforms "mil e cento e catorce" into "mil cento e catorce"
        # Transforms "cem millóns e douscentos mil e douscentos e dez" em "cem
        # millóns douscentos mil douscentos e dez" but "cem millóns e douscentos
        # mil e douscentos" in "cem millóns douscentos mil e douscentos" and not in
        # "cem millóns douscentos mil douscentos"
        for ext in (
                'mil', 'millón', 'millóns', 'mil millóns',
                'billón', 'billóns', 'mil billóns'):
    ...
    # Portugal. Concerning numbers from 2000th on, saying "dous
    ...
    def to_currency(self, val, currency='EUR', cents=True, separator=' e',
        ...
        # transforms "millóns euros" em "millóns de euros"
        cr1, _ = self.CURRENCY_FORMS[currency]

        for ext in (
                'millón', 'millóns', 'billón',
                'billóns', 'trillón', 'trillóns'):
