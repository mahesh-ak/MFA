...
SCALE = {
    ...
    # 10^3
    1: ('хиляда', 'хиляди', 'хиляди', True),

    # 10^6
    2: ('милион', 'милиона', 'милиона', False),

    # 10^9
    3: ('милиард', 'милиарда', 'милиарда', False),

    # 10^12
    4: ('трилион', 'трилиона', 'трилиона', False),

    5: ('квадрилион', 'квадрилиона', 'квадрилиона', False),
    6: ('квинтилион', 'квинтилиона', 'квинтилиона', False),
}
    ...
    def _int2word(self, number, feminine=False):
        ...
        for chunk in chunks:
            ...
            if digit_mid == 1:
                ...
                # insert "и" if there was a hundred before but no tens
                if digit_left > 0 and digit_mid == 0:
                    words.append("и")

                words.append(ONES[digit_right][gender_idx])
            if chunk_len > 0 and int(chunk)!= 0:
