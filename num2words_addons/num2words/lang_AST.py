...
class Num2Word_AST(Num2Word_EU):
    CURRENCY_FORMS = {
    ...
    def setup(self):
        ...
        self.gender_stem = "o"
        self.exclude_title = ["y", "menos", "puntu"]
        self.mid_numwords = [
            (1000, "mil"),
            (100, "cien"),
            (90, "noventa"),
            ...
            (50, "cincuenta"),
            (40, "cuarenta"),
            (30, "trenta"),   # ← AST (not "treinta")
        ]

        self.low_numwords = [
            "ventinueve", "ventiocho", "ventisiete", "ventiséis",
            "venticinco", "venticuatro", "ventitrés", "ventidós",
            "ventiún", "venti",   # ← AST differs from ES "veinti..."
            "diecinueve", "dieciocho", "diecisiete", "dieciséis",
            "quince", "catorce", "trece", "doce", "once", "diez",
            "nueve", "ocho", "siete", "seis", "cinco",
            "cuatro", "tres", "dos", "ún", "cero"
        ]
        self.ords = {1: "primer",
                     2: "segund",
                     3: "tercer",
    ...
    def to_ordinal(self, value, gender='m'):
        gender_stem = 'a' if gender == 'f' else 'u'
    ...
    def to_currency(self, val, currency='EUR', cents=True, separator=' con',
                    adjective=False):
        result = super(Num2Word_AST, self).to_currency(
