...
class Num2WordsTETest(TestCase):
    def test_numbers(self):
        ...
        self.assertEqual(num2words(1734, lang="te"),
            u"వేయీ ఏడు వందల ముప్పై నాలుగు")
        self.assertEqual(num2words(134, lang="te"),
            u"నూట ముప్పై నాలుగు")
        ...
        self.assertEqual(num2words(1729, lang="te"),
            u"వేయీ ఏడు వందల ఇరవై తొమ్మిది")
        self.assertEqual(num2words(123, lang="te"),
            u"నూట ఇరవై మూడు")
        self.assertEqual(num2words(32211, lang="te"),
            u"ముప్పై రెండు వేల రెండు వందల పదకొండు") 
    ...
    def test_ordinal(self):
        self.assertEqual(num2words(1, lang='te', to='ordinal'), u"మొదటి")
