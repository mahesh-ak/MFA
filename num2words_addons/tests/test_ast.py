...
TEST_CASES_CARDINAL = (
    ...
    (2, 'dos'),
    (3, 'tres'),
    (5.5, 'cinco puntu cinco'),
    (11, 'once'),
    (12, 'doce'),
    (16, 'dieciséis'),
    (17.42, 'diecisiete puntu cuatro dos'),
    (19, 'diecinueve'),
    (20, 'venti'),
    (21, 'ventiún'),
    (26, 'ventiséis'),
    (27.312, 'ventisiete puntu tres ún dos'),
    (28, 'ventiocho'),
    (30, 'trenta'),
    (31, 'trenta y ún'),
    (40, 'cuarenta'),
    ...
    (50, 'cincuenta'),
    (53.486, 'cincuenta y tres puntu cuatro ocho seis'),
    ...
    (300.42, 'trescientos puntu cuatro dos'),
    (356, 'trescientos cincuenta y seis'),
    (400, 'cuatrocientos'),
    (434, 'cuatrocientos trenta y cuatro'),
    (578, 'quinientos setenta y ocho'),
    (689, 'seiscientos ochenta y nueve'),
    (729, 'setecientos ventinueve'),
...
TEST_CASES_ORDINAL = (
    ...
    (14, 'decimocuartu'),
    (28, 'vigesimoctavu'),
    (48, 'cuadragésimu octavu'),
    (100, 'centésimu'),
    (1000, 'milésimu'),
    (12345, 'docemilésimu tricentésimu cuadragésimu quintu'),
    (1000000, 'millonésimu'),
    (1000000000000000, 'cuadrillonésimu'),
    (1000000000000000000, 'ún trillón')  # over 1e18 not supported
)
...
TEST_CASES_TO_CURRENCY = (
    (1.00, 'ún euro con cero céntimos'),
    (1.01, 'ún euro con ún céntimo'),
    ...
    (81.25, 'ochenta y ún euros con veinticinco céntimos'),
...
TEST_CASES_TO_CURRENCY_ESP = (
    ...
    (1.01, 'una peseta con ún céntimo'),
...
TEST_CASES_TO_CURRENCY_USD = (
    (1.00, 'ún dólar con cero centavos'),
...
TEST_CASES_TO_CURRENCY_CRC = (
    ...
    (81.25, 'ochenta y ún colones con veinticinco centavos'),
...
TEST_CASES_TO_CURRENCY_RUB = (
    (1.00, 'ún rublo con cero kopeykas'),
    ...
    (81.25, 'ochenta y ún rublos con veinticinco kopeykas'),
...
TEST_CASES_TO_CURRENCY_PLN = (
    ...
    (81.25, 'ochenta y ún zlotys con veinticinco groszy'),
...
TEST_CASES_TO_CURRENCY_MXN = (
    (1.00, 'ún peso con cero centavos'),
    ...
    (81.25, 'ochenta y ún pesos con veinticinco centavos'),
...
TEST_CASES_TO_CURRENCY_HUF = (
    (1.00, 'ún florín con cero fillér'),
    ...
    (81.25, 'ochenta y ún florines con veinticinco fillér'),
...
TEST_CASES_TO_CURRENCY_FRF = (
    (1.00, 'ún franco con cero céntimos'),
    ...
    (81.25, 'ochenta y ún francos con veinticinco céntimos'),
...
TEST_CASES_TO_CURRENCY_CNY = (
    ...
    (81.25, 'ochenta y ún yuanes con veinticinco jiaos'),
...
TEST_CASES_TO_CURRENCY_NIO = (
    (1.00, 'ún córdoba con cero centavos'),
    ...
    (81.25, 'ochenta y ún córdobas con veinticinco centavos'),
...
TEST_CASES_TO_CURRENCY_VES = (
    (1.00, 'ún bolívar con cero céntimos'),
    ...
    (81.25, 'ochenta y ún bolívares con veinticinco céntimos'),
...
TEST_CASES_TO_CURRENCY_BRL = (
    (1.00, 'ún real con cero centavos'),
    ...
    (81.25, 'ochenta y ún reales con veinticinco centavos'),
...
TEST_CASES_TO_CURRENCY_KRW = (
    ...
    (81.25, 'ochenta y ún wones con veinticinco jeon'),
...
TEST_CASES_TO_CURRENCY_KPW = (
    ...
    (81.25, 'ochenta y ún wones con veinticinco chon'),
...
TEST_CASES_TO_CURRENCY_ZAR = (
    (1.00, 'ún rand con cero céntimos'),
    ...
    (81.25, 'ochenta y ún rands con veinticinco céntimos'),
...
TEST_CASES_TO_CURRENCY_KZT = (
    ...
    (81.25, 'ochenta y ún tenges con veinticinco tïın'),
...
TEST_CASES_TO_CURRENCY_UAH = (
    (1.00, 'ún hryvnia con cero kopiykas'),
    ...
    (81.25, 'ochenta y ún hryvnias con veinticinco kopiykas'),
...
TEST_CASES_TO_CURRENCY_THB = (
    ...
    (81.25, 'ochenta y ún bahts con veinticinco satang'),
...
TEST_CASES_TO_CURRENCY_AED = (
    ...
    (81.25, 'ochenta y ún dirhams con veinticinco fils'),
...
TEST_CASES_TO_CURRENCY_AFN = (
    ...
    (81.25, 'ochenta y ún afghanis con veinticinco puls'),
...
TEST_CASES_TO_CURRENCY_ALL = (
    ...
    (81.25, 'ochenta y ún leke con veinticinco qindarka'),
...
TEST_CASES_TO_CURRENCY_AMD = (
    ...
    (81.25, 'ochenta y ún drams con veinticinco lumas'),
...
TEST_CASES_TO_CURRENCY_ANG = (
    (1.00, 'ún florín con cero centavos'),
    ...
    (81.25, 'ochenta y ún florines con veinticinco centavos'),
...
TEST_CASES_TO_CURRENCY_AOA = (
    (1.00, 'ún kwanza con cero céntimos'),
    ...
    (81.25, 'ochenta y ún kwanzas con veinticinco céntimos'),
...
TEST_CASES_TO_CURRENCY_AZN = (
    ...
    (81.25, 'ochenta y ún manat con veinticinco qəpik'),
...
TEST_CASES_TO_CURRENCY_BDT = (
    ...
    (81.25, 'ochenta y ún takas con veinticinco paisas'),
...
TEST_CASES_TO_CURRENCY_BGN = (
    ...
    (81.25, 'ochenta y ún leva con veinticinco stotinki'),
...
TEST_CASES_TO_CURRENCY_BHD = (
    ...
    (81.25, 'ochenta y ún dinares con veinticinco fils'),
...
TEST_CASES_TO_CURRENCY_BOB = (
    (1.00, 'ún boliviano con cero centavos'),
    ...
    (81.25, 'ochenta y ún bolivianos con veinticinco centavos'),
...
TEST_CASES_TO_CURRENCY_BTN = (
    (1.00, 'ún ngultrum con cero chetrum'),
    ...
    (81.25, 'ochenta y ún ngultrum con veinticinco chetrum'),
...
TEST_CASES_TO_CURRENCY_BWP = (
    ...
    (81.25, 'ochenta y ún pulas con veinticinco thebes'),
...
TEST_CASES_TO_CURRENCY_BYN = (
    ...
    (81.25, 'ochenta y ún rublos con veinticinco kópeks'),
...
TEST_CASES_TO_CURRENCY_BZD = (
    (1.00, 'ún dólar con cero céntimos'),
    ...
    (81.25, 'ochenta y ún dólares con veinticinco céntimos'),
...
TEST_CASES_TO_CURRENCY_CVE = (
    (1.00, 'ún escudo con cero centavos'),
    ...
    (81.25, 'ochenta y ún escudos con veinticinco centavos'),
...
TEST_CASES_TO_CURRENCY_DZD = (
    (1.00, 'ún dinar con cero céntimos'),
    ...
    (81.25, 'ochenta y ún dinares con veinticinco céntimos'),
...
TEST_CASES_TO_CURRENCY_ECS = (
    (1.00, 'ún sucre con cero centavos'),
    ...
    (81.25, 'ochenta y ún sucres con veinticinco centavos'),
...
TEST_CASES_TO_CURRENCY_ERN = (
    (1.00, 'ún nakfa con cero céntimos'),
    ...
    (81.25, 'ochenta y ún nakfas con veinticinco céntimos'),
...
TEST_CASES_TO_CURRENCY_ETB = (
    (1.00, 'ún birr con cero céntimos'),
    ...
    (81.25, 'ochenta y ún birrs con veinticinco céntimos'),
...
TEST_CASES_TO_CURRENCY_GEL = (
    ...
    (81.25, 'ochenta y ún laris con veinticinco tetris'),
...
TEST_CASES_TO_CURRENCY_GHS = (
    ...
    (81.25, 'ochenta y ún cedis con veinticinco pesewas'),
...
TEST_CASES_TO_CURRENCY_GMD = (
    (1.00, 'ún dalasi con cero bututs'),
    ...
    (81.25, 'ochenta y ún dalasis con veinticinco bututs'),
...
TEST_CASES_TO_CURRENCY_GTQ = (
    (1.00, 'ún quetzal con cero centavos'),
    ...
    (81.25, 'ochenta y ún quetzales con veinticinco centavos'),
...
TEST_CASES_TO_CURRENCY_HNL = (
    (1.00, 'ún lempira con cero centavos'),
    ...
    (81.25, 'ochenta y ún lempiras con veinticinco centavos'),
...
TEST_CASES_TO_CURRENCY_HRK = (
    ...
    (81.25, 'ochenta y ún kunas con veinticinco lipas'),
...
TEST_CASES_TO_CURRENCY_HTG = (
    (1.00, 'ún gourde con cero céntimos'),
    ...
    (81.25, 'ochenta y ún gourdes con veinticinco céntimos'),
...
TEST_CASES_TO_CURRENCY_ILS = (
    (1.00, 'ún séquel con cero agoras'),
    ...
    (81.25, 'ochenta y ún séqueles con veinticinco agoras'),
...
TEST_CASES_TO_CURRENCY_IRR = (
    ...
    (81.25, 'ochenta y ún riales con veinticinco dinares'),
...
TEST_CASES_TO_CURRENCY_JOD = (
    (1.00, 'ún dinar con cero piastras'),
    ...
    (81.25, 'ochenta y ún dinares con veinticinco piastras'),
...
TEST_CASES_TO_CURRENCY_KES = (
    (1.00, 'ún chelín con cero céntimos'),
    ...
    (81.25, 'ochenta y ún chelines con veinticinco céntimos'),
...
TEST_CASES_TO_CURRENCY_KHR = (
    (1.00, 'ún riel con cero céntimos'),
    ...
    (81.25, 'ochenta y ún rieles con veinticinco céntimos'),
...
TEST_CASES_TO_CURRENCY_LSL = (
    (1.00, 'ún loti con cero céntimos'),
    ...
    (81.25, 'ochenta y ún lotis con veinticinco céntimos'),
...
TEST_CASES_TO_CURRENCY_LTL = (
    (1.00, 'ún lita con cero céntimos'),
    ...
    (81.25, 'ochenta y ún litas con veinticinco céntimos'),
...
TEST_CASES_TO_CURRENCY_LVL = (
    ...
    (81.25, 'ochenta y ún lats con veinticinco céntimos'),
...
TEST_CASES_TO_CURRENCY_LYD = (
    (1.00, 'ún dinar con cero dírhams'),
    ...
    (81.25, 'ochenta y ún dinares con veinticinco dírhams'),
...
TEST_CASES_TO_CURRENCY_MAD = (
    (1.00, 'ún dírham con cero céntimos'),
    ...
    (81.25, 'ochenta y ún dirhams con veinticinco céntimos'),
...
TEST_CASES_TO_CURRENCY_MDL = (
    ...
    (81.25, 'ochenta y ún lei con veinticinco bani'),
...
TEST_CASES_TO_CURRENCY_MGA = (
    (1.00, 'ún ariary con cero iraimbilanja'),
    ...
    (81.25, 'ochenta y ún ariaris con veinticinco iraimbilanja'),
...
TEST_CASES_TO_CURRENCY_MKD = (
    ...
    (81.25, 'ochenta y ún denares con veinticinco denis'),
...
TEST_CASES_TO_CURRENCY_MMK = (
    ...
    (81.25, 'ochenta y ún kiats con veinticinco pyas'),
...
TEST_CASES_TO_CURRENCY_MNT = (
    ...
    (81.25, 'ochenta y ún tugriks con veinticinco möngö'),
...
TEST_CASES_TO_CURRENCY_MOP = (
    ...
    (81.25, 'ochenta y ún patacas con veinticinco avos'),
...
TEST_CASES_TO_CURRENCY_MRO = (
    (1.00, 'ún ouguiya con cero khoums'),
    ...
    (81.25, 'ochenta y ún ouguiyas con veinticinco khoums'),
...
TEST_CASES_TO_CURRENCY_MVR = (
    (1.00, 'ún rufiyaa con cero laari'),
    ...
    (81.25, 'ochenta y ún rufiyaas con veinticinco laari'),
...
TEST_CASES_TO_CURRENCY_MWK = (
    (1.00, 'ún kuacha con cero tambalas'),
    ...
    (81.25, 'ochenta y ún kuachas con veinticinco tambalas'),
...
TEST_CASES_TO_CURRENCY_MYR = (
    (1.00, 'ún ringgit con cero céntimos'),
    ...
    (81.25, 'ochenta y ún ringgit con veinticinco céntimos'),
...
TEST_CASES_TO_CURRENCY_MZN = (
    (1.00, 'ún metical con cero centavos'),
    ...
    (81.25, 'ochenta y ún metical con veinticinco centavos'),
...
TEST_CASES_TO_CURRENCY_NGN = (
    ...
    (81.25, 'ochenta y ún nairas con veinticinco kobo'),
...
TEST_CASES_TO_CURRENCY_OMR = (
    ...
    (81.25, 'ochenta y ún riales con veinticinco baisa'),
...
TEST_CASES_TO_CURRENCY_PAB = (
    (1.00, 'ún balboa con cero centésimos'),
    ...
    (81.25, 'ochenta y ún balboas con veinticinco centésimos'),
...
TEST_CASES_TO_CURRENCY_PGK = (
    ...
    (81.25, 'ochenta y ún kinas con veinticinco toea'),
...
TEST_CASES_TO_CURRENCY_PYG = (
    (1.00, 'ún guaraní con cero céntimos'),
    ...
    (81.25, 'ochenta y ún guaranís con veinticinco céntimos'),
...
TEST_CASES_TO_CURRENCY_QAR = (
    ...
    (81.25, 'ochenta y ún riales con veinticinco dírhams'),
...
TEST_CASES_TO_CURRENCY_RSD = (
    ...
    (81.25, 'ochenta y ún dinares con veinticinco para'),
...
TEST_CASES_TO_CURRENCY_RUR = (
    ...
    (81.25, 'ochenta y ún rublos con veinticinco kopeks'),
...
TEST_CASES_TO_CURRENCY_SAR = (
    (1.00, 'ún riyal con cero halalas'),
    ...
    (81.25, 'ochenta y ún riales con veinticinco halalas'),
...
TEST_CASES_TO_CURRENCY_STD = (
    (1.00, 'ún dobra con cero céntimos'),
    ...
    (81.25, 'ochenta y ún dobras con veinticinco céntimos'),
...
TEST_CASES_TO_CURRENCY_SZL = (
    (1.00, 'ún lilangeni con cero céntimos'),
    ...
    (81.25, 'ochenta y ún emalangeni con veinticinco céntimos'),
...
TEST_CASES_TO_CURRENCY_TJS = (
    (1.00, 'ún somoni con cero dirames'),
    ...
    (81.25, 'ochenta y ún somonis con veinticinco dirames'),
...
TEST_CASES_TO_CURRENCY_TMT = (
    ...
    (81.25, 'ochenta y ún manat con veinticinco tenge'),
...
TEST_CASES_TO_CURRENCY_TND = (
    (1.00, 'ún dinar con cero milésimos'),
    ...
    (81.25, 'ochenta y ún dinares con veinticinco milésimos'),
...
TEST_CASES_TO_CURRENCY_TOP = (
    (1.00, 'ún paanga con cero céntimos'),
    ...
    (81.25, 'ochenta y ún paangas con veinticinco céntimos'),
...
TEST_CASES_TO_CURRENCY_TWD = (
    (1.00, 'ún nuevo dólar con cero céntimos'),
    ...
    (81.25, 'ochenta y ún nuevos dólares con veinticinco céntimos'),
...
TEST_CASES_TO_CURRENCY_UYU = (
    (1.00, 'ún peso con cero centésimos'),
    ...
    (81.25, 'ochenta y ún pesos con veinticinco centésimos'),
...
TEST_CASES_TO_CURRENCY_VEF = (
    (1.00, 'ún bolívar fuerte con cero céntimos'),
    ...
    (81.25, 'ochenta y ún bolívares fuertes con veinticinco céntimos'),
...
TEST_CASES_TO_CURRENCY_VUV = (
    ...
    (81.25, 'ochenta y ún vatu con veinticinco nenhum'),
...
TEST_CASES_TO_CURRENCY_WST = (
    (1.00, 'ún tala con cero centavos'),
    ...
    (81.25, 'ochenta y ún tala con veinticinco centavos'),
...
TEST_CASES_TO_CURRENCY_XAF = (
    (1.00, 'ún franco CFA con cero céntimos'),
    ...
    (81.25, 'ochenta y ún francos CFA con veinticinco céntimos'),
...
TEST_CASES_TO_CURRENCY_XPF = (
    (1.00, 'ún franco CFP con cero céntimos'),
    ...
    (81.25, 'ochenta y ún francos CFP con veinticinco céntimos'),
...
TEST_CASES_TO_CURRENCY_YER = (
    ...
    (81.25, 'ochenta y ún riales con veinticinco fils'),
...
TEST_CASES_TO_CURRENCY_ZMW = (
    ...
    (81.25, 'ochenta y ún kwachas con veinticinco ngwee'),
...
TEST_CASES_TO_CURRENCY_ZRZ = (
    ...
    (81.25, 'ochenta y ún zaires con veinticinco makuta'),
...
class Num2WordsASTTest(TestCase):

    def test_number(self):
        for test in TEST_CASES_CARDINAL:
            self.assertEqual(num2words(test[0], lang='ast'), test[1])

    def test_ordinal(self):
        for test in TEST_CASES_ORDINAL:
            self.assertEqual(
                num2words(test[0], lang='ast', ordinal=True),
                test[1]
            )
    ...
    def test_ordinal_fem(self):
        for test in TEST_CASES_ORDINAL_FEM:
            self.assertEqual(
                num2words(test[0], lang='ast', ordinal=True, gender='f'),
                test[1]
            )
    ...
    def test_ordinal_num(self):
        for test in TEST_CASES_ORDINAL_NUM:
            self.assertEqual(
                num2words(test[0], lang='ast', to='ordinal_num'),
                test[1]
            )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='ESP'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='USD'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='PEN'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='CRC'),
#               test[1]
#           )
...
#       for test in TEST_CASES_TO_CURRENCY_USD:
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='AUD'),
#               test[1]
#           )
...
#       for test in TEST_CASES_TO_CURRENCY_USD:
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='CAD'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='GBP'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='RUB'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='SEK'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='NOK'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='PLN'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='MXN'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='RON'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='INR'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='HUF'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='FRF'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='CNY'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='CZK'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='NIO'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='VES'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='BRL'),
#               test[1]
#           )
...
#       for test in TEST_CASES_TO_CURRENCY_FRF:
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='CHF'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='JPY'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='KRW'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='KPW'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='TRY'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='ZAR'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='KZT'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='UAH'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='THB'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='AED'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='AFN'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='ALL'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='AMD'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='ANG'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='AOA'),
#               test[1]
#           )
...
#       for test in TEST_CASES_TO_CURRENCY_MXN:
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='ARS'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='AWG'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='AZN'),
#               test[1]
#           )
...
#       for test in TEST_CASES_TO_CURRENCY_USD:
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='BBD'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='BDT'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='BGN'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='BHD'),
#               test[1]
#           )
...
#       for test in TEST_CASES_TO_CURRENCY_FRF:
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='BIF'),
#               test[1]
#           )
...
#       for test in TEST_CASES_TO_CURRENCY_USD:
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='BMD'),
#               test[1]
#           )
...
#       for test in TEST_CASES_TO_CURRENCY_USD:
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='BND'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='BOB'),
#               test[1]
#           )
...
#       for test in TEST_CASES_TO_CURRENCY_USD:
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='BSD'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='BTN'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='BWP'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='BYN'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='BYR'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='BZD'),
#               test[1]
#           )
...
#       for test in TEST_CASES_TO_CURRENCY_FRF:
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='CDF'),
#               test[1]
#           )
...
#       for test in TEST_CASES_TO_CURRENCY_MXN:
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='CLP'),
#               test[1]
#           )
...
#       for test in TEST_CASES_TO_CURRENCY_MXN:
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='COP'),
#               test[1]
#           )
...
#       for test in TEST_CASES_TO_CURRENCY_MXN:
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='CUP'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='CVE'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='CYP'),
#               test[1]
#           )
...
#       for test in TEST_CASES_TO_CURRENCY_FRF:
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='DJF'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='DKK'),
#               test[1]
#           )
...
#       for test in TEST_CASES_TO_CURRENCY_MXN:
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='DOP'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='DZD'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='ECS'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='EGP'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='ERN'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='ETB'),
#               test[1]
#           )
...
#       for test in TEST_CASES_TO_CURRENCY_USD:
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='FJD'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='FKP'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='GEL'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='GHS'),
#               test[1]
#           )
...
#       for test in TEST_CASES_TO_CURRENCY_FKP:
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='GIP'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='GMD'),
#               test[1]
#           )
...
#       for test in TEST_CASES_TO_CURRENCY_FRF:
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='GNF'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='GTQ'),
#               test[1]
#           )
...
#       for test in TEST_CASES_TO_CURRENCY_USD:
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='GYD'),
#               test[1]
#           )
...
#       for test in TEST_CASES_TO_CURRENCY_USD:
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='HKD'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='HNL'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='HRK'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='HTG'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='IDR'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='ILS'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='IQD'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='IRR'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='ISK'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='ITL'),
#               test[1]
#           )
...
#       for test in TEST_CASES_TO_CURRENCY_BZD:
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='JMD'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='JOD'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='KES'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='KGS'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='KHR'),
#               test[1]
#           )
...
#       for test in TEST_CASES_TO_CURRENCY_FRF:
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='KMF'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='KWD'),
#               test[1]
#           )
...
#       for test in TEST_CASES_TO_CURRENCY_BZD:
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='KYD'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='LAK'),
#               test[1]
#           )
...
#       for test in TEST_CASES_TO_CURRENCY_EGP:
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='LBP'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='LKR'),
#               test[1]
#           )
...
#       for test in TEST_CASES_TO_CURRENCY_BZD:
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='LRD'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='LSL'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='LTL'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='LVL'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='LYD'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='MAD'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='MDL'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='MGA'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='MKD'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='MMK'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='MNT'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='MOP'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='MRO'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='MRU'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='MUR'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='MVR'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='MWK'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='MYR'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='MZN'),
#               test[1]
#           )
...
#       for test in TEST_CASES_TO_CURRENCY_BZD:
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='NAD'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='NGN'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='NPR'),
#               test[1]
#           )
...
#       for test in TEST_CASES_TO_CURRENCY_USD:
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='NZD'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='OMR'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='PAB'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='PGK'),
#               test[1]
#           )
...
#       for test in TEST_CASES_TO_CURRENCY_MXN:
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='PHP'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='PKR'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='PLZ'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='PYG'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='QAR'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='RSD'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='RUR'),
#               test[1]
#           )
...
#       for test in TEST_CASES_TO_CURRENCY_FRF:
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='RWF'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='SAR'),
#               test[1]
#           )
...
#       for test in TEST_CASES_TO_CURRENCY_BZD:
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='SBD'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='SCR'),
#               test[1]
#           )
...
#       for test in TEST_CASES_TO_CURRENCY_EGP:
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='SDG'),
#               test[1]
#           )
...
#       for test in TEST_CASES_TO_CURRENCY_BZD:
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='SGD'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='SHP'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='SKK'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='SLL'),
#               test[1]
#           )
...
#       for test in TEST_CASES_TO_CURRENCY_BZD:
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='SRD'),
#               test[1]
#           )
...
#       for test in TEST_CASES_TO_CURRENCY_EGP:
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='SSP'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='STD'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='SVC'),
#               test[1]
#           )
...
#       for test in TEST_CASES_TO_CURRENCY_EGP:
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='SYP'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='SZL'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='TJS'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='TMT'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='TND'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='TOP'),
#               test[1]
#           )
...
#       for test in TEST_CASES_TO_CURRENCY_BZD:
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='TTD'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='TWD'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='TZS'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='UAG'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='UGX'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='UYU'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='UZS'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='VEF'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='VND'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='VUV'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='WST'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='XAF'),
#               test[1]
#           )
...
#       for test in TEST_CASES_TO_CURRENCY_BZD:
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='XCD'),
#               test[1]
#           )
...
#       for test in TEST_CASES_TO_CURRENCY_XAF:
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='XOF'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='XPF'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='YER'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='YUM'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='ZMW'),
#               test[1]
#           )
...
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='ZRZ'),
#               test[1]
#           )
...
#       for test in TEST_CASES_TO_CURRENCY_BZD:
#           self.assertEqual(
#               num2words(test[0], lang='ast', to='currency', currency='ZWL'),
#               test[1]
#           )
